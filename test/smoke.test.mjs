...
import { agentsMd, skills, skillList, searchSkills } from "../dist/index.js";
...
test("exposes a generated AGENTS.md string", () => {
  assert.ok(agentsMd.length > 0, "agentsMd is non-empty");
  assert.ok(agentsMd.includes("# Blob Storage"), "blob-storage skill body included");
  assert.ok(agentsMd.startsWith("# Val Town Agent Instructions"), "AGENTS.md starts without YAML frontmatter");
});
